...
Vertex::getAttributeDescriptions() {
	...
	attribute_descriptions[0].format = VK_FORMAT_R32G32B32_SFLOAT; // 3 32-bit signed float components
	...
	attribute_descriptions[1].format = VK_FORMAT_R32G32B32_SFLOAT; // 3 32-bit signed float components
